...
class StockPicking(models.Model):
    ...
    is_enable_order_line = fields.Boolean(string='Include Product Details',
                                          ...
                                          help="If you want to print the "
                                               ...
                                               " enable this field.")
    vehicle_no = fields.Char(string='Truck Reg Number', help="Enter the vehicle number.")
    trailer_no = fields.Char(string='Trailer Number', help="Enter the Trailer number.")
    vehicle_driver_name = fields.Char(string='Driver Name', help="Enter the driver's name.")
    license_driver = fields.Char(string='Driver License', help="Enter the driver's license.")
    driver_contact_number = fields.Char(string='Contact No',
                                        help="Enter the driver's contact"
                                             " number.")
    corresponding_company = fields.Char(string='Transporter Name',
